...
function hasHitWall() {
  ...
  */
  if (snake.head.row === -2 || snake.head.row === ROWS + 2 || snake.head.column === -2 || snake.head.column === COLUMNS + 2) { return true; }


  //if(snake.head.row === -2)
  //if(snake.head.row === ROWS + 2) 
  //{return true;}
  // if(snake.head.column === -2) 
  // {return true;}
  // if(snake.head.column === COLUMNS + 2) 
  // {return true;}
...
function hasCollidedWithSnake() {
  ...
  */
  ...
  var headsColumn = snake.body[0].column
  var headsRow = snake.body[0].row

  for (var i = 1; i < snake.body.length; i++) {
    var tailsRow = snake.body[i].row
    var tailsColumn = snake.body[i].column
    if (headsRow === headsColumn && tailsRow === tailsColumn) { return true }
